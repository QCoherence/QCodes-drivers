...
class SR830(VisaInstrument):
    ...
    def __init__(self, name: str, address: str, **kwargs: Any):
        ...
        self.add_parameter("X_offset", get_cmd="OEXP? 1", get_parser=parse_offset_get)

        self.add_parameter("Y_offset", get_cmd="OEXP? 2", get_parser=parse_offset_get)

        self.add_parameter("R_offset", get_cmd="OEXP? 3", get_parser=parse_offset_get)
        ...
        self.add_parameter("P", get_cmd="OUTP? 4", get_parser=float, unit="deg")
