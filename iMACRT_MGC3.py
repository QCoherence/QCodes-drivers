...
class iMACRT_MGC3(Instrument):
    def __init__(self, name, IP, **kwargs):
        ...
        self.add_parameter(
            ...
            vals=vals.Numbers(
                0, 800
            ),  # 150 modified by Gwen on 28/08/2024 to increase temperature of the whole MXC plate
            unit="uW",
    ...
    def get_idn(self):
        return {"vendor": "iMACRT", "model": "MGD3", "serial": None, "firmware": None}
