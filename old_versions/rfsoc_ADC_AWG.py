...
#mode brute ADC2
seq="SEQ 0,1,10,4106,1,4115,"+str(N_acq)+",4096,"+str(ctrl_dac_adc)
rfsoc.write(seq)
...
time=0.5*1e-3*np.arange(len(adcdataI[0]))
# pour le signal ADC ou I
plt.figure(figsize=(16,6))

if dec_factor is 1 :
	plt.plot(time,adcdataI[0])

elif dec_factor is 8:
	plt.plot(time*8,adcdataI[0])
else:
	raise ValueError('Invalid decimation factor')
